...
kbdLayouts.default.keys = [
	...
	[
		{symbols: [['Caps Lock',301]], extraClasses: 'caps', toggling: true},
		{symbols: [['A','a']]},
		{symbols: [['S','s']]},
		{symbols: [['D','d']]},
		{symbols: [['F','f']]},
	...
	[
		{symbols: [['Shift',304]], extraClasses: 'shift-left'},
		{symbols: [['Z','z']]},
		{symbols: [['X','x']]},
		{symbols: [['C','c']]},
		{symbols: [['V','v']]},
		...
		{symbols: [['Shift',304],['<span class="fnBind">Del</span>',null]], extraClasses: 'arrow'},
	],
	[
		{symbols: [['Ctrl',306]], extraClasses: 'mod ctrl'},
		{symbols: [['Fn',313]], extraClasses: 'mod fn'},
		{symbols: [['Alt',308]], extraClasses: 'mod alt'},
		{symbols: [['',' ']], extraClasses: 'spacebar'},
		{symbols: [['Meta',310]], extraClasses: 'mod meta'},
		{symbols: [['Super',314]], extraClasses: 'mod super'},
